# formatWorker.py - Dedicated formatting worker (WINDOWS COMPATIBLE)
import os
import sys
import redis
...
from queueManager import formattingQueue
...
if __name__ == '__main__':
    print("🚀 Starting dedicated Formatting Worker (Windows compatible)...")
    print("Press Ctrl+C to stop")

    worker = NoForkWorker([formattingQueue], connection=redis_conn)
